...
class FullTextData(BaseModel):
    ...
    sections: Dict[str, GeneReviewSection] = Field(default_factory=dict, description="All scraped sections.")
    metadata: FullTextMetadata = Field(default_factory=FullTextMetadata, description="Extracted metadata.")
...
class GeneReview(BaseModel):
    ...
    summary: Optional[GeneReviewSection] = Field(None, description="The 'Summary' section.")
    diagnosis: Optional[GeneReviewSection] = Field(None, description="The 'Diagnosis' section.")
    management: Optional[GeneReviewSection] = Field(None, description="The 'Management' section.")
    # This field will hold all other scraped sections dynamically
    other_sections: dict[str, GeneReviewSection] = Field(default_factory=dict, description="A dictionary of all other scraped sections.")
    # Enhanced fields
    abstract_data: Optional[AbstractData] = Field(None, description="PubMed abstract and metadata.")
    all_links: Optional[LinkData] = Field(None, description="All available links from PubMed.")
    full_text_data: Optional[FullTextData] = Field(None, description="Comprehensive scraped content.")